...
class Test_place_instantiation(unittest.TestCase):
    ...
    def test_Place_instantiation_bathrooms(self):
        """ Prueba si el número de baños es un atributo de clase público. """
        plc = Place()
    ...
    def test_Place_instantiation_max_guest(self):
        """ Comprobar si 'max_guest' es un atributo de clase público. """
        plc = Place()
    ...
    def test_Place_instantiation_price_(self):
        """ Comprobar si el precio es un atributo de clase público. """
        plc = Place()
    ...
    def test_Place_instantiation_latitude(self):
        """ Probar si la latitud es un atributo de clase público. """
        plc = Place()
    ...
    def test_Place_instantiation_longitude(self):
        """ Comprobar si la longitud es un atributo de clase público. """
        plc = Place()
    ...
    def test_Place_instantiation_amenity(self):
        """ Comprobar si 'amenity' es un atributo de clase público. """
        plc = Place()
